...
export function getDemoProfile(role: DemoRole) {
  if (role === "onboarding") {
    return {
      ...
      is_admin: false,
      is_active: false,
      focus: "Completar la activacion del Paisaporte.",
      building: "Definiendo que quiere aportar y validar dentro de Paisanos.",
  ...
  return [
    {
      ...
      attendedEvents: 5,
      feedbackGiven: 4,
      focus: "Operar la Torre de Control y cerrar el circuito de eventos.",
      avatar: "GM",
      building: "Armando el sistema operativo de Paisaportes y eventos.",
      lookingFor: "Ops, Eventos, Feedback",
      canHelpWith: "Producto, partnerships, research con founders.",
      openTo: "Revisar flujos, abrir accesos y auditar eventos.",
    ...
    },
    {
      ...
      location: "Palermo",
      memberSince: "may 2026",
      lastInteraction: "Asistencia confirmada para Producto en pista",
      attendedEvents: 2,
      feedbackGiven: 3,
  ...
  return [
    {
      ...
      description:
        "Registro propio, check-in, mapa y feedback posterior. Un evento para convertir conversaciones sueltas en proximos pasos concretos.",
      date: "22 de mayo",
      time: "19:30",
      point: "QAF",
    ...
    },
    {
      ...
      description:
        "Registro y check-in se mantienen en Luma, mientras Paisaporte importa asistentes para identidad, historial y seguimiento.",
      date: "5 de junio",
      time: "18:30",
      point: "Luma",
  ...
  return [
    {
      ...
      questions: [
        ...
        "Que parte del evento te dio mas claridad?",
    ...
    return [
      {
        ...
        description: "Cinco miembros para probar registro, check-in y seguimiento posterior.",
        category: "Producto",
        status: "approved",
...
const demoProfiles = {
  admin: {
    ...
    open_to: "Revisar flujos, abrir accesos y auditar eventos.",
    availability: "Martes y jueves, despues de las 18",
  ...
  member: {
    ...
    availability: "Viernes por la tarde",
    last_interaction: "Asistencia confirmada para Producto en pista",
  },
  builder: {
    ...baseProfile,
    id: "profile-demo-builder",
