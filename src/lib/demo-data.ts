...
export function getDemoProfile(role: DemoRole) {
  if (role === "onboarding") {
    return {
      ...
      is_admin: false,
      is_active: false,
      focus: "Completar el primer sello del Paisaporte.",
      building: "Definiendo que tramo quiere abrir dentro de Paisanos.",
  ...
  return [
    {
      ...
      lastInteraction: "Opero la torre Paisanos esta semana",
      attendedEvents: 5,
      feedbackGiven: 4,
      focus: "Operar la torre y cerrar el circuito de escalas.",
      avatar: "GM",
      building: "Armando el sistema operativo de Paisaportes y escalas.",
      lookingFor: "Ops, Escalas, Notas",
      canHelpWith: "Producto, partnerships, research con founders.",
      openTo: "Revisar flujos, abrir accesos y auditar escalas.",
      availability: "Martes y jueves, despues de las 18",
      skills: ["Producto", "Ops", "Partnerships"],
      interests: ["Ops", "Escalas", "Notas"],
    ...
    },
    {
      ...
      location: "Palermo",
      memberSince: "may 2026",
      lastInteraction: "Asiento confirmado para Producto en pista",
      attendedEvents: 2,
      feedbackGiven: 3,
    ...
    },
    {
      ...
      lastInteraction: "Dejo una nota tecnica en Luma Mirror",
      attendedEvents: 3,
      feedbackGiven: 2,
      ...
      openTo: "Dejar notas tecnicas y probar herramientas.",
  ...
  return [
    {
      ...
      title: "Producto en pista",
      subtitle: "Mesa chica para probar el circuito completo dentro de Paisanos",
      description:
        "Asientos nativos, puerta, mapa y notas posteriores. Una escala para convertir conversaciones sueltas en proximos pasos concretos.",
      date: "22 de mayo",
      time: "19:30",
      point: "QAF",
    ...
    },
    {
      ...
      subtitle: "Escala externa preparada para migracion gradual",
      description:
  ...
  return [
    {
      ...
      title: "Notas post Producto en pista",
      status: "Activo",
      deadline: "28 de mayo",
      selectedMembers: 3,
      responses: 2,
      questions: [
        ...
        "Que parte de la escala te dio mas claridad?",
    ...
    return [
      {
        ...
        type: "solution",
        title: "Beta testers para escalas",
        description: "Cinco paisanos para probar asientos, puerta y seguimiento posterior.",
        category: "Producto",
        status: "approved",
...
const demoProfiles = {
  admin: {
    ...
    skills: ["Producto", "Ops", "Partnerships"],
    building: "Armando el sistema operativo de Paisaportes y escalas.",
    looking_for: ["Ops", "Escalas", "Notas"],
    is_admin: true,
    location: "Buenos Aires",
    focus: "Operar la torre y cerrar el circuito de escalas.",
    can_help_with: "Producto, partnerships, research con founders.",
    open_to: "Revisar flujos, abrir accesos y auditar escalas.",
    availability: "Martes y jueves, despues de las 18",
  ...
  member: {
    ...
    availability: "Viernes por la tarde",
    last_interaction: "Asiento confirmado para Producto en pista",
  },
  builder: {
    ...baseProfile,
    id: "profile-demo-builder",
    ...
    open_to: "Dejar notas tecnicas y probar herramientas.",
    availability: "Miercoles al mediodia",
    last_interaction: "Dejo una nota tecnica en Luma Mirror",
  },
